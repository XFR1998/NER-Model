...
def parse_args():
    ...
    parser.add_argument('--max_len', default=54, type=int, help="text max len")
    ...
    parser.add_argument('--nezha_dir', type=str, default='../pretrain_models/nezha-cn-base')
    parser.add_argument('--roberta_dir', type=str, default='../pretrain_models/hfl/chinese-roberta-wwm-ext')
    parser.add_argument('--macbert_dir', type=str, default='../pretrain_models/hfl/chinese-macbert-base')
